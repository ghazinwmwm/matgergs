...
const TEMPLATES: Template[] = [
  {
    id: "minimal",
    name: "بسيط",
    description: "تصميم نظيف وبسيط يركز على المنتجات مع تنقل سهل",
    category: "مجاني",
    colors: ["#FFFFFF", "#000000", "#0EA5E9"],
    features: ["تصميم متجاوب", "عرض شبكي", "فلتر المنتجات"],
  },
  {
    id: "elegant",
    name: "أنيق",
    description: "تصميم فاخر مناسب للماركات والمنتجات الراقية",
    category: "مجاني",
    colors: ["#1A1A2E", "#E2B857", "#FFFFFF"],
    features: ["تصميم داكن", "أنيميشن سلس", "عرض المنتج بالكامل"],
    popular: true,
  },
  {
    id: "vibrant",
    name: "حيوي",
    description: "تصميم ملون وعصري مناسب للملابس والأزياء",
    category: "مجاني",
    colors: ["#FF6B6B", "#4ECDC4", "#FFFFFF"],
    features: ["ألوان زاهية", "صور كبيرة", "كاروسيل"],
  },
  {
    id: "professional",
    name: "احترافي",
    ...
    category: "مميز",
    colors: ["#2D3436", "#00B894", "#FFFFFF"],
    features: ["مقارنة المنتجات", "تقييمات", "مدونة مدمجة", "SEO متقدم"],
    popular: true,
  },
  {
    id: "luxury",
    name: "فخم",
    description: "تصميم فخم مع تأثيرات بصرية مذهلة",
    category: "مميز",
    colors: ["#0C0C0C", "#D4AF37", "#FAF0E6"],
    features: ["تأثيرات 3D", "فيديو خلفية", "عرض VIP", "تخصيص كامل"],
  },
  {
    id: "fresh",
    name: "منعش",
    description: "تصميم خفيف ومنعش مناسب لمنتجات العناية والجمال",
    category: "مميز",
    colors: ["#F8F9FA", "#A8E6CF", "#FFB7B2"],
    features: ["تدرجات لونية", "أيقونات مخصصة", "قسم المراجعات", "عروض خاصة"],
  },
];
...
const Templates = () => {
  ...
  const filtered = TEMPLATES.filter(
    (t) => activeCategory === "الكل" || t.category === activeCategory
  );
              ...
              <div className="p-4">
                ...
                <div className="flex flex-wrap gap-1.5 mt-2.5">
                  {template.features.map((feature) => (
                    <span key={feature} className="text-[10px] px-2 py-0.5 rounded-full bg-secondary text-secondary-foreground">
                      {feature}
                    </span>
                  ))}
                </div>
