...
import { Plus, Search, Ticket, Copy, Trash2, ToggleLeft, ToggleRight, Percent, Hash } from "lucide-react";
    ...
    <div className="min-h-screen bg-background pb-24">
      <div className="container mx-auto px-4 pt-10 pb-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold text-foreground">أكواد الخصم</h1>
            <p className="text-sm text-muted-foreground mt-0.5">{coupons.length} كود</p>
          </div>
            ...
            filtered.map((coupon) => (
              <div key={coupon.id} className="bg-card border border-border rounded-xl p-4">
                ...
                <div className="flex items-center justify-between mt-3 pt-3 border-t border-border">
                  ...
                  <button onClick={() => deleteCoupon(coupon.id)} className="text-muted-foreground hover:text-destructive transition-colors">
